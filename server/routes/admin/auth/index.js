...
router.post('/registration', async(req, res) => {
    ...
    const newAdmin = await authController.addNew(req.body.firstName, req.body.lastName, req.body.dateOfBirth, req.body.image, req.body.username, req.body.password)
